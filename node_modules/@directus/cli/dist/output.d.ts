...
export declare type TableStyle = 'compact' | 'minimal' | 'markdown';
export declare type TableCellAlignment = 'left' | 'center' | 'right';
...
export declare type OutputColumn = {
    text: string;
    options?: Partial<TextLayoutOptions>;
};
export declare type Style = (text: string) => string;
...
export declare type FormatData = {
