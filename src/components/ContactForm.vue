...
<template>
    <div class="max-w-xl shadow-2xl rounded-xl isolate bg-white pt-12 pb-12 px-6 lg:px-8">
      ...
      <div class="mx-auto max-w-2xl text-center">
        <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">{{ $t('contact-form.heading') }}</h2>
        <p class="mt-2 text-lg leading-8 text-gray-600">{{ $t('contact-form.subheading') }}</p>
      </div>
      <form action="#" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-5">
        <div class="grid grid-cols-1 gap-y-6 gap-x-8 sm:grid-cols-2">
          <div>
            <label for="first-name" class="block text-sm font-semibold leading-6 text-gray-900">{{ $t('contact-form.name') }}</label>
            <div class="mt-2.5">
          ...
          <div>
            <label for="last-name" class="block text-sm font-semibold leading-6 text-gray-900">{{ $t('contact-form.surname') }}</label>
            <div class="mt-2.5">
        ...
        <div class="mt-10">
          <button type="submit" class="block w-full rounded-md bg-hovers-logo px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">{{ $t('contact-form.send') }}</button>
        </div>
      </form>
    </div>
  </template>
